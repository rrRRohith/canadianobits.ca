 ...
 */
class AncoraPayPalDonations_Widget extends WP_Widget
{
    /**
     * Register the Widget.
     */
    ...
    {
        $widget_ops = array(
            'classname' => 'widget_ancora_paypal_donations',
            'description' => __(
                'Ancora PayPal Donation Button',
                AncoraPayPalDonations::TEXT_DOMAIN
            )
        );
        parent::__construct('ancora_paypal_donations', 'Ancora PayPal Donations', $widget_ops);
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $paypal_donations = AncoraPayPalDonations::getInstance();
    ...
    public function form($instance)
    {
        ...
        $defaults = array(
            'title'     => __('Donate', AncoraPayPalDonations::TEXT_DOMAIN),
            'text'      => '',
            'purpose'   => '',
            'reference' => ''
        );
        ...
        echo AncoraPayPalDonations_View::render('widget-form', $data);
    }
}
