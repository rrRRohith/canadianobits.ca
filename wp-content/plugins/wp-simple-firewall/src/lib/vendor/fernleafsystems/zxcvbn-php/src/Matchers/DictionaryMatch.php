...
class DictionaryMatch extends BaseMatch
{
    ...
    public const START_UPPER = "/^[A-Z][^A-Z]+$/u";
    public const END_UPPER = "/^[^A-Z]+[A-Z]$/u";
    public const ALL_UPPER = "/^[^a-z]+$/u";
    public const ALL_LOWER = "/^[^A-Z]+$/u";
     ...
     */
    public static function doMatch($password, array $userInputs = [], $rankedDictionaries = []): array
    {
        $matches = [];
