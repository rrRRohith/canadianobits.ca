...
use AptowebDeps\PhpConsole\Connector;
use AptowebDeps\PhpConsole\Handler as VendorPhpConsoleHandler;
use AptowebDeps\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['AptowebDeps\\Monolog\\'],
    ...
    {
        if (!\class_exists('AptowebDeps\\PhpConsole\\Connector')) {
