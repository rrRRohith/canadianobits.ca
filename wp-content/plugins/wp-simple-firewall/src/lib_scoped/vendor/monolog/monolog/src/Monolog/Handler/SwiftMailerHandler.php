...
use AptowebDeps\Swift_Message;
use AptowebDeps\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\AptowebDeps\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
