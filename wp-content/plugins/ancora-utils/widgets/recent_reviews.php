...
class ancora_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'ancora-utils'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'ancora_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'ancora_widget_recent_reviews', __('Ancora - Recent reviews', 'ancora-utils'), $widget_ops, $control_ops );
