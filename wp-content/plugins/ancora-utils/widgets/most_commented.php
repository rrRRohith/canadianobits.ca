...
class ancora_widget_most_commented extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_most_commented', 'description' => __('The most popular and most commented blog posts (extended)', 'ancora-utils'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'ancora_widget_most_commented');

		/* Create the widget. */
		parent::__construct( 'ancora_widget_most_commented', __('Ancora - Most Commented Posts', 'ancora-utils'), $widget_ops, $control_ops );
	}
