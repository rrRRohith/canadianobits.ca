...
class ancora_widget_most_viewed extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_most_viewed', 'description' => __('The most popular and most commented blog posts (extended)', 'ancora-utils'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'ancora_widget_most_viewed');

		/* Create the widget. */
		parent::__construct( 'ancora_widget_most_viewed', __('Ancora - Most Viewed Posts', 'ancora-utils'), $widget_ops, $control_ops );
	}
